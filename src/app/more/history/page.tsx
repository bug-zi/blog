import { getHistoryEvents } from "@/lib/posts";
...
export default function HistoryPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {events.length === 0 ? (
        <p className="text-center text-sm text-muted py-8">暂无历史事件</p>
      ) : (
        <div className="relative">
          ...
          <div className="space-y-8">
            {events.map((event) => (
              <div key={event.slug} className="flex items-start gap-4 relative">
